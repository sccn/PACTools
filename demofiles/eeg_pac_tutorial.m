...
% 
%
% In this demo, multiple trial and single trial PAC data are simulateds. PAC estimation is performed using
% the Mean Vector Length and Instantaneous MIPAC method to the single trial data and the 
% Generalized Linear Model and Event Related - MIPAC for multiple trials data.
...
%% Visualizations  of single trial PAC estimation using Mean Vector Length Modulation Index from Canolty et al. 2006
