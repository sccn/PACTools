...
if isempty(varargin);
    ...
    plotmvl_enable   = 'off'; plotklmi_enable   = 'off';
    if s_trial,
    ...
    plot_callback = ['hfig = gcbf; opttmp = eval([''{'' get(findobj(gcf,''tag'',''edit_optionalparams''),''string'') ''}'']);options = { opttmp{:},      ''time'',             str2num(get(findobj(hfig,''tag'',''edit_comodtime''),''string''))/1000,'...
    ...
    uilist = { ...
        ...
        { 'style', 'text', 'string','Temporal Comodulogram'},     {'Style', 'checkbox', 'value', g.plotcomodt,  'tag' 'chckbox_comodt'   'Enable' plotcomodt_enable }, {'style', 'text', 'string', 'Time (ms)'},            {'style' 'edit' 'string' '200 : 250 : 2000' 'tag' 'edit_comodtime'} ...
        ...
        { 'style', 'text', 'string','Mean-Vector Histogram'},     {'Style', 'checkbox', 'value', g.plotmvl,     'tag' 'chckbox_mvhist'   'Enable' plotmvl_enable},     {'Style', 'text','string' '# bins'},                {'style' 'edit' 'string' '15' 'tag' 'edit_mvbins'} ...
        { 'style', 'text', 'string','Kullback-Leibler Histogram'},{'Style', 'checkbox', 'value', g.plotkl,      'tag' 'chckbox_klhist'   'Enable' plotklmi_enable}...
    ...
    geometry = {{2.3 14 [0 0]  [1 1]}...
                ...
                {2.3 14 [0 12] [1 1]}...
                {2.3 14 [0 13] [0.5 1]}  {2.3 14 [1.33 13] [0.5 1]}  {2.3 14 [1.8 13] [0.5 1]}};
