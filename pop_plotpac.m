...
if isempty(varargin);
    ...
    plot_callback = ['hfig = gcbf; opttmp = eval([''{'' get(findobj(gcf,''tag'',''edit_optionalparams''),''string'') ''}'']);options = { opttmp{:},      ''time'',             str2num(get(findobj(hfig,''tag'',''edit_comodtime''),''string'')),'...
