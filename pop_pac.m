...
if nargin <8 
    ...
    geometry = {    {2.7 9 [0 0] [1 1]}  {2.7 9 [0.6 0] [0.8 1]}...
                ...
                {2.7 9 [0 5] [1 1]} ...
                {2.7 9 [0.2 6] [1 1]} {2.7 9 [1.26 6] [0.5 1]}...
                {2.7 9 [0.2 7] [1 1]} {2.7 9 [1.26 7] [0.5 1]}...
                {2.7 9 [0.2 8] [1 1]} {2.7 9 [1.26 8] [0.5 1]}...
                {2.7 9 [0 9] [1 1]}};
 %%
    ...
    uilist = {{'style' 'text' 'string' 'PAC data type' 'fontweight' 'bold' } {'style' 'popupmenu' 'string' datatypel_list 'tag' 'datatype' 'value' 1}...
              ...
              {'style' 'text' 'string' 'Correct for multiple comparisons' 'callback' 'close(gcbf);' } {'style' 'checkbox' 'tag' 'bonfcorr'}...
              {}};
    ...
    options = {'freqs' phasefreq 'freqs2' ampfreq 'nfreqs1' g.nfreqs1 'nfreqs2' g.nfreqs2 'methodpac' g.methodpac 'nboot' g.nboot 'alpha' g.alpha 'bonfcorr' g.bonfcorr};
end
